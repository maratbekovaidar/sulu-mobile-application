...
import 'package:sulu_mobile_application/utils/model/master_models/master_portfolio_model.dart';
 ...
 class EstablishmentService {
  ...
  Future<List<EstablishmentModel>> getEstablishmentsWithFilter(int typeId) async {
    ...
    final Future<List<EstablishmentModel>>result = _networkClient.get(path: "private/client/findEstablishmentByName/serviceTypeId/userToken",parser: establishmentParser,headerParameters: {
      'Content-Type': 'application/json',
      'Authorization': token!
    },
      parameters: {
